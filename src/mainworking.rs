    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut Frame) {
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            if self.selected_file.is_some() {
                ...
                columns[0].set_width(avail_width - 300.0);
                println!("column 0 width {}. col 1 width {}", columns[0].available_width(), columns[1].available_width() );
                ...
                columns[0].label(egui::RichText::new(artist_label).color(egui::Color32::WHITE).size(16.0));
                ...
                columns[0].label(egui::RichText::new(title_label).color(egui::Color32::WHITE).size(16.0));
                ...
                columns[0].label(egui::RichText::new(album_label).color(egui::Color32::WHITE).size(16.0));
                ...
                columns[0].label(egui::RichText::new(genre_label).color(egui::Color32::WHITE).size(16.0));
                ...
                if !self.album_art_ready { // not ready yet
                    columns[1].label("Loading...");
                } else if let Some(tex) = &self.selected_album_art {
                    columns[1].image((*tex, egui::Vec2::splat(300.0)));
                } else {
                    columns[1].label("No album art");
                }
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    options.viewport.inner_size = Some(egui::vec2(900.0, 400.0));
